        ...
        >
            ...
            <div className="py-12">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div className="mt-4">
                        <Link href={route('seller.deals.index')} className="text-blue-500">🔙 Back to Deals</Link>
                    </div>
                    ...
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg p-6">
                        ...
                        {deal.condition_day && !deal.is_condition_day_confirmed && (
                            <div className="mt-6 p-4 border rounded-md bg-yellow-50 text-yellow-800">
                                ...
                                <button
                                    ...
                                    onClick={() => {
                                        fetch(route('seller.deals.confirmConditionDay', deal.id), {
                                            method: 'PATCH',
                                            headers: {
                                                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]')?.getAttribute('content') || '',
                                                'Content-Type': 'application/json',
                        ...
                        {deal.possession_day && !deal.is_possession_day_confirmed && (
                            <div className="mt-6 p-4 border rounded-md bg-yellow-50 text-yellow-800">
                                ...
                                <button
                                    onClick={() => {
                                        fetch(route('seller.deals.confirmPossessionDay', deal.id), {
                                            method: 'PATCH',
                                            headers: {
                                                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]')?.getAttribute('content') || '',
                                                'Content-Type': 'application/json',
